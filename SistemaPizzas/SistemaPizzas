...
public class SistemaPizzas {
    public static void main(String[] args) {
        ...
        Pizza miPizza = new PizzaBase(tamaño);
        ...
        while (true) {
            ...
            if (entrada.equaalsIgnoreCase("FIN")) {
                break;
            }
            ...
            switch (entrada.toLowerCase()) {
                ...
                case "pepperoni":
                    ...
                    break;
                case "aceitunas":
                    miPizza = new Aceitunas(miPizza);
                    break;
                case "tocineta":
                    miPizza = new Tocineta(miPizza);
                    break;
                default:
                    System.out.println("Ingrediente no válido. Intente de nuevo.");
                    continue;
            }
            System.out.println("Ingrediente agregado: " + entrada);
        }
